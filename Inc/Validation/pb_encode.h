...
/*
 * Included from: https://github.com/nanopb/nanopb/
 */

/*!
 * \file pb_encode.h
 * \brief Functions to encode protocol buffers. Depends on 
 *        pb_encode.c. The main function is pb_encode. You also
 *        need an output stream, and the field descriptions 
